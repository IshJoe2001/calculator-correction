    ...
    key.addEventListener('click', Event =>{
        ...
        if (opId == "+" || opId== "-" || opId == "/" || opId == "x"){
            ...
            if(operationInCurse == "on") {
                ...
                onScreen.textContent = Math.round(resolveOp(operator)*100000000)/100000000;
            }
        ...
        if (opId === "="){             
            ...
            onScreen.textContent = Math.round(resolveOp(operator)*100000000)/100000000; // fits numbers to screen
            }
            operator = "";
            onScreenOp.textContent = "";
            operationInCurse = "off";  
